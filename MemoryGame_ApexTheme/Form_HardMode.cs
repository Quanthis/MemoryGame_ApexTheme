...
{
    public partial class Form_HardMode : Form
    {
        Match CheckForMatches = new Match();
        GetFormInfo formInfo;
        long secondsElapsed;

        public Form_HardMode()
        {
            InitializeComponent();
        }

        private void Form_HardMode_Load(object sender, EventArgs e)
        {
        ...
        private void Backpack_2_Click(object sender, EventArgs e)
        {
        ...
        {
            CheckForMatches.AddButton(ref Me);
            CheckForMatches.Matched();
        }

        private void Me_2_Click(object sender, EventArgs e)
        {
            CheckForMatches.AddButton(ref Me_2);
            CheckForMatches.Matched();
        }

        private void jojow_Click(object sender, EventArgs e)
        {
            CheckForMatches.AddButton(ref jojow);
            CheckForMatches.Matched();
        }

        private void jojow_2_Click(object sender, EventArgs e)
        {
            CheckForMatches.AddButton(ref jojow_2);
            CheckForMatches.Matched();
        }

        private void Vulnat_Click(object sender, EventArgs e)
        {
            CheckForMatches.AddButton(ref Vulnat);
            CheckForMatches.Matched();
        }

        private void Vulnat_2_Click(object sender, EventArgs e)
        {
            CheckForMatches.AddButton(ref Vulnat_2);
            CheckForMatches.Matched();
        }

        private void Vezoro_Click(object sender, EventArgs e)
        {
            CheckForMatches.AddButton(ref Vezoro);
            CheckForMatches.Matched();
        }

        private void button1_Click(object sender, EventArgs e)
        {
            CheckForMatches.AddButton(ref Vezoro_2);
            CheckForMatches.Matched();
        }
